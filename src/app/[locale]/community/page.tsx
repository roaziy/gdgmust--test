  ...
  return (
    <div className="">
      ...
      <div className='flex justify-center items-center flex-col mt-10 text-center max-w-2xl mx-auto px-4 pb-8'>
        ...
        <p className='text-[14px] max-w-[500px] md:text-[16px] lg:text-[16px] leading-4 md:leading-5 lg:leading-5'>{t('CommunityPage.header.description')}</p>
      </div>
      ...
      <nav className='flex justify-center items-center mt-1' draggable="false">
        <button className='flex justify-center item-center select-none bg-white border border-black rounded-full px-5 h-[42px]'>
          ...
          <IoMenu className='ml-[8px] mt-[11px] size-5' />
        </button>
      </nav>
      ...
      <div className=''>
        ...
        <div className='flex justify-center items-center flex-col mt-10 text-center max-w-2xl mx-auto px-4 pb-10'>
          ...
          <p className='text-[14px] max-w-[500px] md:text-[16px] lg:text-[16px] leading-4 md:leading-5 lg:leading-5'>{t('CommunityPage.JoinUs.description')}</p>
        </div>
        ...
        >
          <a
            className='bg-[#00AAFF] w-[220px] lg:w-[213px] h-[38px] lg:h-[42px] flex items-center justify-center rounded-full m-1 
          ...
          <a
            className='bg-[#5865F2] w-[220px] lg:w-[239px] h-[38px] lg:h-[42px] rounded-full flex items-center justify-center m-1 mt-1'
