...
const Footer = () => {
  return (
    <div className="w-full flex flex-col items-center pt-[69px] pb-[100px] lg:pb-[78px] md:pb-[100px] sm:pb-[100px] px-5 md:px-10 bg-[#F6F6F6] select-none">
      <div className="w-full max-w-[1300px] flex flex-col lg:flex-row justify-between items-center text-center lg:text-left">
        ...
        <div className="flex flex-col items-center lg:items-end mt-8 lg:mt-0">
          ...
          <div className="mt-6 lg:mt-0 md:mt-6 sm:mt-6 text-center lg:text-right">
            <p className="text-[19px] mt-2">Ulaanbaatar, Mongolia</p>
            <p className="text-[15px] -mt-[6px] flex items-center justify-end">
              Made with <Image src={pixelHeart} alt="Pixel Heart" width={15} height={15} className="mx-1"/> in UB © 2025
            </p>
            <p className="text-[14px] -mt-[6.5px]">Developed by <a href="https://www.instagram.com/roaziy/" target="_blank" rel="noopener noreferrer"><span className="" id="font-gbold">roaziy</span></a></p>
          </div>
        </div>
      </div>
    </div>
