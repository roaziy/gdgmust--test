...
export const Introduction = () => {
    const t = useTranslations(); // Move the hook inside the component
    
    // Add this effect to reset scroll on mount
    useEffect(() => {
      window.scrollTo(0, 0);
    }, []);
...
const IntroductionSectionContent = () => {
  ...
  const t = useTranslations(); // Import and use the translation hook
