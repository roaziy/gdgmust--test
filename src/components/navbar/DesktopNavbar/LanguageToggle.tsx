...
const Logobar = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-between gap-[15px] px-[10px] py-[9px] bg-white outline-none outline-1 outline-black outline-offset-0 rounded-full"
