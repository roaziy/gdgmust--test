...
const Logobar = () => {
  ...
  return (
    <div
      className="relative flex items-center justify-between gap-[15px] px-[10px] py-[9px] bg-white/80 shadow-[0px_1px_7px] shadow-gray-300/80 backdrop-blur-md rounded-full"
